...
Widget backArrow(BuildContext context, [int screenNumb = 0])
{
  return GestureDetector(
      onTap: () => { Navigator.pushReplacement(context, PageTransition(type: PageTransitionType.fade, child: BottomNavigation(ScreenNumb: screenNumb)) )},
      child: Container(
        height: 10,
        width: 10,
